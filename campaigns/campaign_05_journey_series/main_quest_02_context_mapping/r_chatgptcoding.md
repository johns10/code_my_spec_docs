...
- Refactoring time dropped like 70% - I'm mostly kicking out obvious architectural drift
...
I wrote up the full process here if anyone wants to try it: [insert blog link]
...
anyone else doing something similar? or am i just way late to this and everyone already does architecture conversations before coding?

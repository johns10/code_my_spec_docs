...
MCP (Model Context Protocol) server that exposes component management, dependency tracking, architecture analysis, and design workflow tools to AI agents via Anubis. Provides comprehensive CRUD operations for components, dependency graph manipulation, similar component tracking, context design workflows, and architecture health reporting. This server enables AI agents like Claude Code to interact with the CodeMySpec component system through standardized MCP tool calls.

...
That's the agent layer. The execution loop, tool use, and context management that turn a stateless text generator into something that can actually write software. That's [Article 3: The Agent Layer](/articles/03-the-agent-layer).

...
*This is Part 4 of "The Anatomy of Agentic Coding Systems." [Part 3 covered the Agent Layer](/articles/03-the-agent-layer) - the execution loop, tool use, and context management. Part 5 covers the Environment Layer - where AI code actually runs.*

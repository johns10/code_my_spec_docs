...
meta_title: End User License Agreement - CodeMySpec
meta_description: License terms for installing and using the CodeMySpec CLI, Claude Code plugin, and other locally-installed software.
og_title: End User License Agreement - CodeMySpec
og_description: License terms for the CodeMySpec CLI and locally-installed software.
og_image: null
...
This EULA covers the Software you install locally. Use of the hosted website and APIs at codemyspec.com is governed by our [Terms of Service](/pages/terms-of-service).
...
- See our [Privacy Policy](/pages/privacy-policy) for details on what we collect and how we handle it.
...
For questions about this EULA, contact us through the website at [codemyspec.com](https://codemyspec.com).

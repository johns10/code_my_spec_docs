---
# Metadata for agentic_software_development_process.md

# Required fields
slug: agentic-software-development-process
type: blog
title: "The Agentic Software Development Process"
...
# SEO Metadata
meta_title: "The Agentic Software Development Process: 8 Phases"
meta_description: "Most teams use AI agents for one phase. The full lifecycle has eight: requirements, architecture, specs, implementation, testing, QA, deploy, maintenance."
og_title: "The Agentic Software Development Process (8 Phases)"
og_description: "Requirements, architecture, specs, implementation, testing, QA, deployment, maintenance. The full agentic development lifecycle, phase by phase, with data."
og_image: null
...
The conversation about AI coding tools keeps circling one question: "which agent writes the best code?" That's the wrong question. Code generation is one phase of software development. Seven others exist, and most of them matter more.
...
The fix: TDD where the agent is told which specific tests to check (not just "do TDD", which [makes things worse](https://arxiv.org/abs/2603.17973)). BDD specs from acceptance criteria so tests come from requirements, not implementation. The [cassette pattern](https://anaynayak.medium.com/eliminating-flaky-tests-using-vcr-tests-for-llms-a3feabf90bc5) for non-deterministic LLM output. And Meta's [JiTTests](https://engineering.fb.com/2026/02/11/developer-tools/the-death-of-traditional-testing-agentic-development-jit-testing-revival/) concept: ephemeral tests per PR, discarded after they run.

...
*This is Part 3 of "The Anatomy of Agentic Coding Systems." [Part 2 covered the Model Layer](/articles/02-the-model-layer) - what the LLM actually is and isn't. Part 4 covers the Harness Layer - why the wrapper matters more than the model.*

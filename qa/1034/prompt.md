# QA Story 1034: Story search stays fast as the backlog grows
...
As a user, I want story search to stay fast as the backlog grows so that I can find stories quickly.
...
Write the brief to `.code_my_spec/qa/1034/brief.md` matching this spec exactly.

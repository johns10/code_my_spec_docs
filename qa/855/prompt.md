# QA Story 855: My app sends mail from my own domain
...
Sam's app can send email from his domain, and the domain shows verified before setup finishes.

## Acceptance criteria

- Sam's domain is known to the mail provider
- The signing and bounce records resolve publicly
- Setup waits for verification rather than assuming it
- A real message arrives from Sam's domain
- Existing inbound mail survives the sending setup
- Test mail cannot pass for production mail
- A UAT-only project completes without a sending domain

## BDD spec files

- `test/spex/969_my_app_sends_mail_from_my_own_domain/criterion_8024_sams_domain_is_known_to_the_mail_provider_spex.exs`
- `test/spex/969_my_app_sends_mail_from_my_own_domain/criterion_8025_the_signing_and_bounce_records_resolve_publicly_spex.exs`
- `test/spex/969_my_app_sends_mail_from_my_own_domain/criterion_8026_setup_waits_for_verification_rather_than_assuming_it_spex.exs`
- `test/spex/969_my_app_sends_mail_from_my_own_domain/criterion_8028_a_real_message_arrives_from_sams_domain_spex.exs`
- `test/spex/969_my_app_sends_mail_from_my_own_domain/criterion_8029_existing_inbound_mail_survives_the_sending_setup_spex.exs`
- `test/spex/969_my_app_sends_mail_from_my_own_domain/criterion_8056_test_mail_cannot_pass_for_production_mail_spex.exs`

## Linked component: Resend

This story is implemented by `CodeMySpec.Provisioning.Resend` (module).
Reading the source code and spec will help you understand what to
test and how the feature works.

- Tests: `test/code_my_spec/provisioning/resend_test.exs`
- Spec: `.code_my_spec/spec/code_my_spec/provisioning/resend.spec.md`
- Source: `lib/code_my_spec/provisioning/resend.ex`
...
Write the brief to `.code_my_spec/qa/855/brief.md` matching this spec exactly.

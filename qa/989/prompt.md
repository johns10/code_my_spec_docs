# QA Story 989: I manage the servers my account owns, separately from any project
...
As a solo founder, I want an account-level view and control surface for my Hetzner servers -- see them, link them, provision new ones, retire them -- that lives outside any single project's context, so infrastructure decisions aren't made accidentally as a side effect of one project's devops run.

## Acceptance criteria

- Sam creates a server from the account-level page
- A project's own devops step cannot create a server
- Sam links, provisions, and retires from one screen
- An unlinked server stays visible, collapsed
- A shared server's page lists every project on it
- Retiring a server still serving a project is refused
- A regular account member can view but not create

## BDD spec files

- `test/spex/1044_i_manage_the_servers_my_account_owns_separately_from_any_project/criterion_3061_sam_creates_a_server_from_the_account-level_page_spex.exs`
- `test/spex/1044_i_manage_the_servers_my_account_owns_separately_from_any_project/criterion_3062_a_projects_own_devops_step_cannot_create_a_server_spex.exs`
- `test/spex/1044_i_manage_the_servers_my_account_owns_separately_from_any_project/criterion_3063_sam_links_provisions_and_retires_from_one_screen_spex.exs`
- `test/spex/1044_i_manage_the_servers_my_account_owns_separately_from_any_project/criterion_3064_an_unlinked_server_stays_visible_collapsed_spex.exs`
- `test/spex/1044_i_manage_the_servers_my_account_owns_separately_from_any_project/criterion_3065_a_shared_servers_page_lists_every_project_on_it_spex.exs`
- `test/spex/1044_i_manage_the_servers_my_account_owns_separately_from_any_project/criterion_3068_retiring_a_server_still_serving_a_project_is_refused_spex.exs`
- `test/spex/1044_i_manage_the_servers_my_account_owns_separately_from_any_project/criterion_3069_a_regular_account_member_can_view_but_not_create_spex.exs`
...
Write the brief to `.code_my_spec/qa/989/brief.md` matching this spec exactly.

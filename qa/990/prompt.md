# QA Story 990: My project's devops only ever touches its own container and its own infrastructure
...
As a solo founder, I want my project's own devops setup to manage its container, database, DNS records, and secrets -- and nothing about shared servers -- so onboarding a new project can never duplicate infrastructure another project already has.

## Acceptance criteria

- An unlinked environment pauses the server step
- Broken_oaths-style duplicate creation no longer happens
- A vanished linked server pauses instead of being silently rebuilt
- No project-scoped path reaches create-server
- A fully-linked project's devops run is unchanged
- A granted server unblocks the paused step on the next run

## BDD spec files

- `test/spex/1045_my_projects_devops_only_ever_touches_its_own_container_and_its_own_infrastructure/criterion_3070_an_unlinked_environment_pauses_the_server_step_spex.exs`
- `test/spex/1045_my_projects_devops_only_ever_touches_its_own_container_and_its_own_infrastructure/criterion_3071_broken_oaths-style_duplicate_creation_no_longer_happens_spex.exs`
- `test/spex/1045_my_projects_devops_only_ever_touches_its_own_container_and_its_own_infrastructure/criterion_3072_a_vanished_linked_server_pauses_instead_of_being_silently_rebuilt_spex.exs`
- `test/spex/1045_my_projects_devops_only_ever_touches_its_own_container_and_its_own_infrastructure/criterion_3073_no_project-scoped_path_reaches_create-server_spex.exs`
- `test/spex/1045_my_projects_devops_only_ever_touches_its_own_container_and_its_own_infrastructure/criterion_3074_a_fully-linked_projects_devops_run_is_unchanged_spex.exs`
- `test/spex/1045_my_projects_devops_only_ever_touches_its_own_container_and_its_own_infrastructure/criterion_3075_a_granted_server_unblocks_the_paused_step_on_the_next_run_spex.exs`

## Linked component: Steps

This story is implemented by `CodeMySpec.Provisioning.Steps` (module).
Reading the source code and spec will help you understand what to
test and how the feature works.

- Tests: `test/code_my_spec/provisioning/steps_test.exs`
- Spec: `.code_my_spec/spec/code_my_spec/provisioning/steps.spec.md`
- Source: `lib/code_my_spec/provisioning/steps.ex`
...
Write the brief to `.code_my_spec/qa/990/brief.md` matching this spec exactly.

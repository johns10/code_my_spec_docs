# QA Story 865: Solo shipper sees the users who registered for their application
...
As Solo Shipper Sam, I want to see a list of the users who have registered for my application.

## Acceptance criteria

- Sam views his registered users
- The request carries the project's deploy key
- An HTTPS client API URL is accepted
- An HTTP client API URL is rejected
- The target app is unreachable
- The target app rejects the deploy key
- Sam pages through a large user list

## BDD spec files

- `test/spex/814_solo_shipper_sees_the_users_who_registered_for_their_application/criterion_6560_sam_views_his_registered_users_spex.exs`
- `test/spex/814_solo_shipper_sees_the_users_who_registered_for_their_application/criterion_6562_the_request_carries_the_projects_deploy_key_spex.exs`
- `test/spex/814_solo_shipper_sees_the_users_who_registered_for_their_application/criterion_6564_an_https_client_api_url_is_accepted_spex.exs`
- `test/spex/814_solo_shipper_sees_the_users_who_registered_for_their_application/criterion_6565_an_http_client_api_url_is_rejected_spex.exs`
- `test/spex/814_solo_shipper_sees_the_users_who_registered_for_their_application/criterion_6566_the_target_app_is_unreachable_spex.exs`
- `test/spex/814_solo_shipper_sees_the_users_who_registered_for_their_application/criterion_6567_the_target_app_rejects_the_deploy_key_spex.exs`
- `test/spex/814_solo_shipper_sees_the_users_who_registered_for_their_application/criterion_6568_sam_pages_through_a_large_user_list_spex.exs`

## Linked component: ProjectUsers

This story is implemented by `CodeMySpec.ProjectUsers` (context).
Reading the source code and spec will help you understand what to
test and how the feature works.

- Tests: `test/code_my_spec/project_users_test.exs`
- Spec: `.code_my_spec/spec/code_my_spec/project_users.spec.md`
- Source: `lib/code_my_spec/project_users.ex`
...
Write the brief to `.code_my_spec/qa/865/brief.md` matching this spec exactly.

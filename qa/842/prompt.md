# QA Story 842: Formal release process
...
As a user, I want a formal release process — every story that clears QA goes to UAT, and prod releases happen at the end of the cycle with release notes — so shipping has a rhythm I can trust.

## Acceptance criteria

- The release waits for the journeys
- Release notes name the stories that shipped
- The release is published in all three places
- The user approves the release from their phone
- A declined release stands down
- A fresh UAT deploy reopens the release

## BDD spec files

- `test/spex/842_formal_release_process/criterion_1971_the_release_waits_for_the_journeys_spex.exs`
- `test/spex/842_formal_release_process/criterion_1972_release_notes_name_the_stories_that_shipped_spex.exs`
- `test/spex/842_formal_release_process/criterion_1973_the_release_is_published_in_all_three_places_spex.exs`
- `test/spex/842_formal_release_process/criterion_1974_the_user_approves_the_release_from_their_phone_spex.exs`
- `test/spex/842_formal_release_process/criterion_1975_a_declined_release_stands_down_spex.exs`
- `test/spex/842_formal_release_process/criterion_1976_a_fresh_uat_deploy_reopens_the_release_spex.exs`
...
Write the brief to `.code_my_spec/qa/842/brief.md` matching this spec exactly.

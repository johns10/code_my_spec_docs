# QA Story 839: Model and system share one analysis run record
...
As an agent working in a CodeMySpec project, when I run mix test or mix spex the run is routed through the analysis service, so my results and the stop hook's results are one shared record and nothing runs twice on unchanged code.
...
This story is implemented by `CodeMySpec.Analysis` (module).
Reading the source code and spec will help you understand what to
test and how the feature works.

- Tests: `test/code_my_spec/analysis_test.exs`
- Spec: `.code_my_spec/spec/code_my_spec/analysis.spec.md`
- Source: `lib/code_my_spec/analysis.ex`
...
Write the brief to `.code_my_spec/qa/839/brief.md` matching this spec exactly.

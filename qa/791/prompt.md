# QA Story 791: Context Design Review
...
As an architect, I want an agent-driven review of a context spec together with its child specs, so that design errors get fixed in the specs before they are baked into implementation.

## Acceptance criteria

- Review prompt enumerates the context spec and every child spec path
- Leaf component types never receive a review task
- Review surfaces once context and all child specs validate
- Review is blocked while any child spec is missing
- Review path is computed by replacing .spec.md with /design_review.md
- Review written off-path leaves the canonical path unsatisfied
- Schema-conforming review document evaluates as valid
- Review document missing a required section is rejected with feedback
- Passing review unblocks downstream implementation requirements
- Pending review keeps implementation off the actionable queue

## BDD spec files

- `test/spex/78_context_design_review/criterion_5572_review_prompt_enumerates_the_context_spec_and_every_child_spec_path_spex.exs`
- `test/spex/78_context_design_review/criterion_5573_leaf_component_types_never_receive_a_review_task_spex.exs`
- `test/spex/78_context_design_review/criterion_5574_review_surfaces_once_context_and_all_child_specs_validate_spex.exs`
- `test/spex/78_context_design_review/criterion_5575_review_is_blocked_while_any_child_spec_is_missing_spex.exs`
- `test/spex/78_context_design_review/criterion_5576_review_path_is_computed_by_replacing_spec_md_with_design_review_md_spex.exs`
- `test/spex/78_context_design_review/criterion_5577_review_written_off_path_leaves_the_canonical_path_unsatisfied_spex.exs`
- `test/spex/78_context_design_review/criterion_5578_schema_conforming_review_document_evaluates_as_valid_spex.exs`
- `test/spex/78_context_design_review/criterion_5579_review_document_missing_a_required_section_is_rejected_with_feedback_spex.exs`
- `test/spex/78_context_design_review/criterion_5580_passing_review_unblocks_downstream_implementation_requirements_spex.exs`
- `test/spex/78_context_design_review/criterion_5581_pending_review_keeps_implementation_off_the_actionable_queue_spex.exs`
...
Write the brief to `.code_my_spec/qa/791/brief.md` matching this spec exactly.

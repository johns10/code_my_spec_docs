# QA Story 814: Account creation is the first step of /app's wizard
...
As a new user landing on /app for the first time, I want to name and create my account inline as the first wizard step, so that I own it intentionally rather than having one auto-provisioned at signup.

## Acceptance criteria

- Unauthenticated visitor is redirected to login
- /app renders the create-account form for users who own zero accounts
- Submitting the create-account form creates a personal account with the user-supplied name and sets it as the user's active account
- Invalid submissions (empty name) re-render the form with validation errors and do not create an account
- Users who own one or more accounts but have no active selection have the first account auto-assigned and skip the create-account step
- Returning users with an active account skip the create-account step entirely

## BDD spec files

- `test/spex/606_account_creation_is_the_first_step_of_apps_wizard/criterion_5399_unauthenticated_visitor_is_redirected_to_login_spex.exs`
- `test/spex/606_account_creation_is_the_first_step_of_apps_wizard/criterion_5513_user_with_zero_accounts_sees_the_create_account_form_spex.exs`
- `test/spex/606_account_creation_is_the_first_step_of_apps_wizard/criterion_5514_valid_submission_creates_the_account_and_advances_onboarding_spex.exs`
- `test/spex/606_account_creation_is_the_first_step_of_apps_wizard/criterion_5516_invalid_submission_re_renders_the_form_with_errors_spex.exs`
- `test/spex/606_account_creation_is_the_first_step_of_apps_wizard/criterion_5517_user_with_accounts_but_no_active_one_has_the_first_account_auto_assigned_spex.exs`
- `test/spex/606_account_creation_is_the_first_step_of_apps_wizard/criterion_5518_returning_user_with_an_active_account_skips_directly_to_the_next_step_spex.exs`
...
Write the brief to `.code_my_spec/qa/814/brief.md` matching this spec exactly.

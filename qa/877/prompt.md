# QA Story 877: My images are built on infrastructure I never maintain
...
As a solo founder, I want my images built on demand by infrastructure I never see, so that deploying is something I ask for rather than something I operate.

## Acceptance criteria

- Creating a project builds nothing
- Deploying builds the image on demand
- The builder produces an image the server can run
- An image built for the wrong architecture is caught, not shipped
- The builder is gone once the image exists
- A failed build still takes its builder with it
- A deploy does not pay for the toolchain every time
- The deploy pulls without asking GitHub for anything
- Old images stop costing money without anyone remembering to delete them

## BDD spec files

- `test/spex/992_my_images_are_built_on_infrastructure_i_never_maintain/criterion_8232_creating_a_project_builds_nothing_spex.exs`
- `test/spex/992_my_images_are_built_on_infrastructure_i_never_maintain/criterion_8233_deploying_builds_the_image_on_demand_spex.exs`
- `test/spex/992_my_images_are_built_on_infrastructure_i_never_maintain/criterion_8234_the_builder_produces_an_image_the_server_can_run_spex.exs`
- `test/spex/992_my_images_are_built_on_infrastructure_i_never_maintain/criterion_8235_an_image_built_for_the_wrong_architecture_is_caught_not_shipped_spex.exs`
- `test/spex/992_my_images_are_built_on_infrastructure_i_never_maintain/criterion_8236_the_builder_is_gone_once_the_image_exists_spex.exs`
- `test/spex/992_my_images_are_built_on_infrastructure_i_never_maintain/criterion_8237_a_failed_build_still_takes_its_builder_with_it_spex.exs`
- `test/spex/992_my_images_are_built_on_infrastructure_i_never_maintain/criterion_8239_a_deploy_does_not_pay_for_the_toolchain_every_time_spex.exs`
- `test/spex/992_my_images_are_built_on_infrastructure_i_never_maintain/criterion_8240_the_deploy_pulls_without_asking_github_for_anything_spex.exs`
- `test/spex/992_my_images_are_built_on_infrastructure_i_never_maintain/criterion_8241_old_images_stop_costing_money_without_anyone_remembering_to_delete_them_spex.exs`

## Linked component: Builder

This story is implemented by `CodeMySpec.Provisioning.Builder` (module).
Reading the source code and spec will help you understand what to
test and how the feature works.

- Tests: `test/code_my_spec/provisioning/builder_test.exs`
- Spec: `.code_my_spec/spec/code_my_spec/provisioning/builder.spec.md`
- Source: `lib/code_my_spec/provisioning/builder.ex`
...
Write the brief to `.code_my_spec/qa/877/brief.md` matching this spec exactly.

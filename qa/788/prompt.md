# QA Story 788: Project Administration
...
As a user, I want to create and manage projects with associated accounts so that I can organize my development work and configure project settings.

## Acceptance criteria

- Index lists projects belonging to the active account
- Valid new-project submission creates the project and shows it in the index
- Empty name re-renders the form with validation errors
- Lowercase module_name re-renders the form with the module-name format error
- Editing project settings persists the changes
- Delete removes the project from the index

## BDD spec files

- `test/spex/62_project_administration/criterion_6079_index_lists_projects_belonging_to_the_active_account_spex.exs`
- `test/spex/62_project_administration/criterion_6080_valid_new_project_submission_creates_the_project_spex.exs`
- `test/spex/62_project_administration/criterion_6081_empty_name_re_renders_the_form_with_validation_errors_spex.exs`
- `test/spex/62_project_administration/criterion_6082_lowercase_module_name_re_renders_the_form_with_module_name_format_error_spex.exs`
- `test/spex/62_project_administration/criterion_6083_editing_project_settings_persists_the_changes_spex.exs`
- `test/spex/62_project_administration/criterion_6084_delete_removes_the_project_from_the_index_spex.exs`
...
Write the brief to `.code_my_spec/qa/788/brief.md` matching this spec exactly.

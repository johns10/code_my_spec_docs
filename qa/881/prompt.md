# QA Story 881: A message from the widget reaches the people who can answer it
...
As an operator, I want a message someone sends from the widget on my site to arrive as a conversation my account can see, so that it gets answered instead of lost.
...
## Linked component: ConversationChannel

This story is implemented by `CodeMySpecWeb.ConversationChannel` (module).
Reading the source code and spec will help you understand what to
test and how the feature works.

- Tests: `test/code_my_spec_web/conversation_channel_test.exs`
- Spec: `.code_my_spec/spec/code_my_spec_web/conversation_channel.spec.md`
- Source: `lib/code_my_spec_web/conversation_channel.ex`
...
Write the brief to `.code_my_spec/qa/881/brief.md` matching this spec exactly.

# QA Story 961: An agent I am done with stops, and stops consuming
...
As a solo founder, I want to stop an agent and know it is actually stopped, so that a lane I am finished with releases its working copy and spends nothing more on my behalf.

## Acceptance criteria

- Started, seen, stopped
- Nothing keeps spending after the thing that started it is gone
- Stopping an agent stops the thing that spends money
- A row that says stopped over a process that is still running
- A lane leaving is not a process exiting
- The pid survives long enough to be used
- Two lanes on one copy, one of them stopped
- Cancelling one we asked for and never saw
- The stop travels to the machine holding the process
- An agent mid-commit gets to finish it
- An agent that ignores the ask still stops
- An agent still working comes back to finish
- An agent I stopped is not resurrected by a restart

## BDD spec files

- `test/spex/1018_a_pi_agent_starts_in_a_minted_working_copy_on_my_own_subscription/criterion_2827_started_seen_stopped_spex.exs`
- `test/spex/1018_a_pi_agent_starts_in_a_minted_working_copy_on_my_own_subscription/criterion_2828_nothing_keeps_spending_after_the_thing_that_started_it_is_gone_spex.exs`
- `test/spex/1023_an_agent_i_am_done_with_stops_and_stops_costing/criterion_2873_stopping_an_agent_stops_the_thing_that_spends_money_spex.exs`
- `test/spex/1023_an_agent_i_am_done_with_stops_and_stops_costing/criterion_2874_a_row_that_says_stopped_over_a_process_that_is_still_running_spex.exs`
- `test/spex/1023_an_agent_i_am_done_with_stops_and_stops_costing/criterion_2875_a_lane_leaving_is_not_a_process_exiting_spex.exs`
- `test/spex/1023_an_agent_i_am_done_with_stops_and_stops_costing/criterion_2876_the_pid_survives_long_enough_to_be_used_spex.exs`
- `test/spex/1023_an_agent_i_am_done_with_stops_and_stops_costing/criterion_2879_two_lanes_on_one_copy_one_of_them_stopped_spex.exs`
- `test/spex/1023_an_agent_i_am_done_with_stops_and_stops_costing/criterion_2880_cancelling_one_we_asked_for_and_never_saw_spex.exs`
- `test/spex/1023_an_agent_i_am_done_with_stops_and_stops_costing/criterion_2881_the_stop_travels_to_the_machine_holding_the_process_spex.exs`
- `test/spex/1023_an_agent_i_am_done_with_stops_and_stops_costing/criterion_2884_an_agent_mid_commit_gets_to_finish_it_spex.exs`
- `test/spex/1023_an_agent_i_am_done_with_stops_and_stops_costing/criterion_2885_an_agent_that_ignores_the_ask_still_stops_spex.exs`
- `test/spex/1023_an_agent_i_am_done_with_stops_and_stops_costing/criterion_2890_an_agent_still_working_comes_back_to_finish_spex.exs`
- `test/spex/1023_an_agent_i_am_done_with_stops_and_stops_costing/criterion_2891_an_agent_i_stopped_is_not_resurrected_by_a_restart_spex.exs`
...
Write the brief to `.code_my_spec/qa/961/brief.md` matching this spec exactly.

...
and BDD spex against the sandbox project.
...
- The spex suite (`mix spex test/spex/688_*/`) is the authoritative contract
  test. This QA pass exercises the MCP tool surface from outside the BEAM and
  confirms the BDD contract passes in full.

# QA Story 962: I can watch a background agent work and talk to it
...
As a solo founder running a background agent, I want to see everything it has done and send it a message from the same place, so that I can follow its work and redirect it without a terminal.

## Acceptance criteria

- Two agents on one copy are two conversations
- I watch the work arrive
- A turn that fails still shows what it did first
- I redirect an agent without a terminal
- A message that could not be delivered says so
- Something I said mid-turn is not dropped
- The send box does not accept what it cannot deliver
- What it did outlives it
- I change my mind before it lands
- Taking back one the agent already has does not pretend to work

## BDD spec files

- `test/spex/1024_i_can_watch_a_background_agent_work_and_talk_to_it/criterion_2892_two_agents_on_one_copy_are_two_conversations_spex.exs`
- `test/spex/1024_i_can_watch_a_background_agent_work_and_talk_to_it/criterion_2893_i_watch_the_work_arrive_spex.exs`
- `test/spex/1024_i_can_watch_a_background_agent_work_and_talk_to_it/criterion_2894_a_turn_that_fails_still_shows_what_it_did_first_spex.exs`
- `test/spex/1024_i_can_watch_a_background_agent_work_and_talk_to_it/criterion_2895_i_redirect_an_agent_without_a_terminal_spex.exs`
- `test/spex/1024_i_can_watch_a_background_agent_work_and_talk_to_it/criterion_2896_a_message_that_could_not_be_delivered_says_so_spex.exs`
- `test/spex/1024_i_can_watch_a_background_agent_work_and_talk_to_it/criterion_2897_something_i_said_mid_turn_is_not_dropped_spex.exs`
- `test/spex/1024_i_can_watch_a_background_agent_work_and_talk_to_it/criterion_2898_the_send_box_does_not_accept_what_it_cannot_deliver_spex.exs`
- `test/spex/1024_i_can_watch_a_background_agent_work_and_talk_to_it/criterion_2899_what_it_did_outlives_it_spex.exs`
- `test/spex/1024_i_can_watch_a_background_agent_work_and_talk_to_it/criterion_2900_i_change_my_mind_before_it_lands_spex.exs`
- `test/spex/1024_i_can_watch_a_background_agent_work_and_talk_to_it/criterion_2901_taking_back_one_the_agent_already_has_does_not_pretend_to_work_spex.exs`
...
Write the brief to `.code_my_spec/qa/962/brief.md` matching this spec exactly.

# QA Story 866: Sam sends and receives messages with his users
...
As Solo Shipper Sam, I want to send and receive messages with my users so I can support my app and build relationships with them.

## Acceptance criteria

- User starts a conversation
- Account starts a conversation
- Replies append to the same thread
- History is shown on return
- Live delivery while connected
- Delivery on next connect
- Teammate reads and replies
- User sees only their own conversation
- Cross-user access is denied
- Online status reflects connection
- Conversations span all projects

## BDD spec files

- `test/spex/815_sam_sends_and_receives_messages_with_his_users/criterion_6569_user_starts_a_conversation_spex.exs`
- `test/spex/815_sam_sends_and_receives_messages_with_his_users/criterion_6570_account_starts_a_conversation_spex.exs`
- `test/spex/815_sam_sends_and_receives_messages_with_his_users/criterion_6571_replies_append_to_the_same_thread_spex.exs`
- `test/spex/815_sam_sends_and_receives_messages_with_his_users/criterion_6572_history_is_shown_on_return_spex.exs`
- `test/spex/815_sam_sends_and_receives_messages_with_his_users/criterion_6573_live_delivery_while_connected_spex.exs`
- `test/spex/815_sam_sends_and_receives_messages_with_his_users/criterion_6574_delivery_on_next_connect_spex.exs`
- `test/spex/815_sam_sends_and_receives_messages_with_his_users/criterion_6575_teammate_reads_and_replies_spex.exs`
- `test/spex/815_sam_sends_and_receives_messages_with_his_users/criterion_6576_user_sees_only_their_own_conversation_spex.exs`
- `test/spex/815_sam_sends_and_receives_messages_with_his_users/criterion_6577_cross-user_access_is_denied_spex.exs`
- `test/spex/815_sam_sends_and_receives_messages_with_his_users/criterion_6578_online_status_reflects_connection_spex.exs`
- `test/spex/815_sam_sends_and_receives_messages_with_his_users/criterion_6579_conversations_span_all_projects_spex.exs`

## Linked component: InboxLive

This story is implemented by `CodeMySpecWeb.InboxLive` (liveview).
Reading the source code and spec will help you understand what to
test and how the feature works.

- Tests: `test/code_my_spec_web/live/inbox_live_test.exs`
- Spec: `.code_my_spec/spec/code_my_spec_web/inbox_live.spec.md`
- Source: `lib/code_my_spec_web/live/inbox_live.ex`
...
Write the brief to `.code_my_spec/qa/866/brief.md` matching this spec exactly.

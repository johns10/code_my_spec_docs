# QA Story 969: My deploy points at the registry I actually own
...
As Sam, I want my generated deploy config to authenticate against the registry CodeMySpec actually provisioned for me, not ghcr.io, so that deploying doesn't need a GitHub credential I may not have and doesn't reference infrastructure that was never set up.
...
## Linked component: Provisioning

This story is implemented by `CodeMySpec.Provisioning` (coordination_context).
Reading the source code and spec will help you understand what to
test and how the feature works.

- Tests: `test/code_my_spec/provisioning_test.exs`
- Spec: `.code_my_spec/spec/code_my_spec/provisioning.spec.md`
- Source: `lib/code_my_spec/provisioning.ex`
...
Write the brief to `.code_my_spec/qa/969/brief.md` matching this spec exactly.

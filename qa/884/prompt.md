# QA Story 884: I can fix what my setup is missing, and keep what I meant to leave
...
As a solo founder, I want to build what the health check says is missing and mark the leftovers I keep on purpose, so the page ends up green without me deleting something that turns out to matter.

## Acceptance criteria

- Fixing from the health page builds the missing thing and turns it green
- A fix that fails says which thing failed and leaves the rest alone
- A record added for another tool stops being reported as broken
- Trimming leaves a marked resource alone
- Marking survives the resource list being rebuilt

## BDD spec files

- `test/spex/999_i_can_fix_what_my_setup_is_missing_and_keep_what_i_meant_to_leave/criterion_8302_fixing_from_the_health_page_builds_the_missing_thing_and_turns_it_green_spex.exs`
- `test/spex/999_i_can_fix_what_my_setup_is_missing_and_keep_what_i_meant_to_leave/criterion_8303_a_fix_that_fails_says_which_thing_failed_and_leaves_the_rest_alone_spex.exs`
- `test/spex/999_i_can_fix_what_my_setup_is_missing_and_keep_what_i_meant_to_leave/criterion_8304_a_record_added_for_another_tool_stops_being_reported_as_broken_spex.exs`
- `test/spex/999_i_can_fix_what_my_setup_is_missing_and_keep_what_i_meant_to_leave/criterion_8305_trimming_leaves_a_marked_resource_alone_spex.exs`
- `test/spex/999_i_can_fix_what_my_setup_is_missing_and_keep_what_i_meant_to_leave/criterion_8306_marking_survives_the_resource_list_being_rebuilt_spex.exs`
...
Write the brief to `.code_my_spec/qa/884/brief.md` matching this spec exactly.

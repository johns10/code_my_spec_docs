# QA Story 840: Analyzer activity gauge on project home
...
As an engineer supervising agent work, I want a small per-analyzer status gauge on the project home page so I can see at a glance what's running, what's fresh, and what found problems.
...
## Linked component: HomeLive

This story is implemented by `CodeMySpecLocalWeb.HomeLive` (module).
Reading the source code and spec will help you understand what to
test and how the feature works.

- Tests: `test/code_my_spec_local_web/home_live_test.exs`
- Spec: `.code_my_spec/spec/code_my_spec_local_web/home_live.spec.md`
- Source: `lib/code_my_spec_local_web/home_live.ex`
...
Write the brief to `.code_my_spec/qa/840/brief.md` matching this spec exactly.

# QA Story 846: Shared inbox for end-user conversations
...
As an operator, I want a shared inbox of my end-users' chat threads, so that anyone on my account can read and reply to a user's messages.
...
Write the brief to `.code_my_spec/qa/846/brief.md` matching this spec exactly.

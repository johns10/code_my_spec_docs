<!-- cms:task type="ComponentCode" component="CodeMySpec.TestContext.Widget" -->
...
Component Description: Schema child for step-through test
Type: schema

Spec File: .code_my_spec/spec/code_my_spec/test_context/widget.spec.md
Test File: test/code_my_spec/test_context/widget_test.exs
...
Write the implementation to lib/code_my_spec/test_context/widget.ex

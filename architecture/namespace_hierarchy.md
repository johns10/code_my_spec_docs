...
│   │   ├── CliConfig [module]
│   │   ├── Elixir [module]
│   │   ├── PhoenixInstaller [module]
│   │   ├── PhoenixProject [module]
│   │   └── Postgresql [module]
...
│   │   ├── AgentsMd [module]
│   │   ├── AppResources [module]
│   │   ├── ApplicationInWeb [module]
│   │   ├── ClaudeMd [module]
│   │   ├── CodemyspecDeps [module]
│   │   ├── Compilers [module]
│   │   ├── CredoChecks [module]
│   │   ├── Helpers [module]
...
│   │   ├── Rules [module]
│   │   ├── SpexConfig [module]
│   │   ├── TestBoundaries [module]
│   │   └── TestSupportNamespace [module]
│   ├── StartAgentTask [module] Orchestrates agent task session startup. Validates inputs, syncs the project, resolves the correct AgentTask module, ...
...
│   └── Sync [module] Synchronizes components from filesystem to database. Parent-child relationships are derived from module name hierarch...
│       └── FileInfo [module]
├── Content [module]
│   ├── Content [module]
...
│   ├── Bootstrap
│   │   ├── BootstrapMapper [module]
│   │   ├── Content [module]
│   │   └── Tools
│   │       ├── InitProject [module]
│   │       ├── InstallAgentsMd [module]
│   │       ├── InstallAppResources [module]
│   │       ├── InstallClaudeMd [module]
│   │       ├── InstallCredoChecks [module]
│   │       ├── InstallRules [module]
│   │       └── ListProjects [module]
│   ├── Components
...
│   ├── LocalServer [module]
│   ├── Requirements
│   │   ├── RequirementsMapper [module]
│   │   └── Tools
│   │       ├── GetNextRequirement [module]
│   │       ├── ListRequirements [module]
│   │       └── SyncProject [module]
│   ├── Stories
...
│   ├── FileWatcherServer [module] Singleton GenServer that watches project directories for file changes and runs incremental component sync. Manages mu...
│   ├── StatusWriter [module]
...
└── Vault [module]
CodeMySpecLocalWeb [module]
├── AgentTaskController [module]
├── Application [module]
├── BootstrapController [module]
├── ComponentsRequirementsController [module]
...
├── Hooks
│   ├── NotificationHookController [module]
│   ├── PostToolUseController [module]
│   ├── PreToolUseController [module]
│   ├── SessionStartController [controller]
│   ├── StopController [controller]
│   └── SubagentStopController [module]
├── InitHTML [module]
├── InitLive [module]
├── IssuesLive
│   ├── Index [module]
│   └── Show [module]
├── Layouts [module]
├── MarkdownBrowserController [module]
├── MarkdownBrowserLive [module]
├── McpPlug [module]
├── Migrator [module]
...
│   ├── ProjectScope [module]
│   ├── WorkingDir [module]
│   └── WorkingDirScope [module]
├── RequirementsController [module]
├── RequirementsGraphController [module]
├── RequirementsLive [module]
├── RequirementsMarkdown [module]
├── Router [module]
├── SessionsLive [module]
├── StoriesRequirementsController [module]
├── SyncLive [module]
└── Tasks
    └── NextTaskLive [module]
